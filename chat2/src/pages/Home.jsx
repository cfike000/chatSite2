...
const Home = () => {
  ...
  const styles = {
    sideMenu: `relative bg-slate-200 sm:w-48  w- h-border border-r-slate-500/[.15]  overflow-visible  `,
    chatMain: `bg-white w-full flex flex-col  transition ease-in-out duration-[250ms]  ${
      sideMenuOpen ? "" : null
    }`,
    //add toggle to condition to fix
    mainContainer: `flex h-[22rem] sm:h-[42rem] transition ease-in-out duration-[250ms]  ${
      sideMenuOpen ? "translate-x-[-10rem] toggle" : null
    } `,
  }
